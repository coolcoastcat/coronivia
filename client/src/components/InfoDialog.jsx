        ...
        <DialogContent>
          <DialogContentText component={'span'}  style={{fontSize:'14px', verticalAlign: 'middle'}}>
            <Paper >
                ...
                a nicer playing experience. The questions and this entire project are released under the 
                same <a href='http://creativecommons.org/licenses/by-sa/4.0/' target='_blank' rel="noopener noreferrer">license</a> used in the Open Trivia Database project.
                </Box>
                <Box m={3}>
