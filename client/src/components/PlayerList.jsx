    ...
    render(){
        ...
        if(this.state.players){
            playerItems = this.state.players.map((player) =>  <div key={player.name} id='player-content-body'>
                                ...
                                <div id='player-data-column'>{JSON.stringify(player.connected)}</div>
            ...
            <div id='player-body-wrapper'>
                <div id='player-body-table'>
                    <div id='player-content-body'>
                        <div id='player-labels-column-hd'>Player</div><div id='player-data-column-hd'>Is Connected</div><div id='player-data-column-hd'>Score</div>
                    </div>
                    {playerItems}
                </div> 
            </div>
